...
import man1 from '../images/images/men-01.jpg';
import man2 from '../images/images/men-02.jpg';
import man3 from '../images/images/men-03.jpg';
function Section2() {
    const slide = [
      {
        image:man1,
  ...
  return (
    <div id='Section-2' className='flex flex-col  items-center justify-center md:items-start h-full py-24 border-b-4 border-dotted'>
        <div className='pb-14 flex flex-col pl-14 md:pl-24'> 
            <h1 className='text-4xl font-Roboto tracking-wide  text-zinc-700 font-semibold '>Men's Latest</h1>
